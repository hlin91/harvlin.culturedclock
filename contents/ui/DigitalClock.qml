...
Item {
    ...
    function transformNumbersInString(s) {
        let stringArray = s.split("");
        return stringArray.map((c) => {
            switch (c) {
            case '0':
                return '零';
            case '1':
    ...
    */
    Item {
        ...
        Grid {
            ...
            Components.Label  {
                ...
                text: transformNumbersInString(Qt.formatTime(main.getCurrentTime(), main.timeFormat))
    ...
    function setupLabels() {
        ...
        if (main.showDate) {
            dateLabel.text = transformNumbersInString(Qt.formatDate(main.getCurrentTime(), main.dateFormat));
        } else {
        ...
        var timeAm = transformNumbersInString(Qt.formatTime(date, format));
        var advanceWidthAm = timeMetrics.advanceWidth(timeAm);
        date.setHours(13);
        var timePm = transformNumbersInString(Qt.formatTime(date, format));
